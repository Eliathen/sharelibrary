...
public class ChatController {
    ...
    public ResponseEntity<List<ChatRoomResponse>> getUserRooms(@PathVariable("user") Long userId) {
    ...
    public ResponseEntity<List<ChatMessageResponse>> getRoomMessages(@PathVariable("id") Long roomId) {
        return new ResponseEntity<>(
